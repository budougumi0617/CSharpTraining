...
namespace EV3Application.LCD
{
	...
	public abstract class AlphanumericDisplayBase : IDisplay
	{
		...
		/// </summary>
		/// <returns>
		/// <para><see cref="EV3Application.LCD.AlphanumericDisplayBase.Message"/>が半角英数字スペースのみで構成されていれば<c>true</c>を返す。</para>
		/// <para><see cref="EV3Application.LCD.AlphanumericDisplayBase.Message"/>が半角英数字スペース以外が含まれていれば<c>false</c>を返す。</para>
		/// </returns>
